# 😈 HappyDemon - O Chatbot Poliglota que Aprende com Você

![Python Version](https://img.shields.io/badge/Python-3.8+-blue?logo=python&logoColor=white)
![Platform](https://img.shields.io/badge/Platform-Windows%20|%20Linux%20|%20macOS-lightgrey)
![SQLite](https://img.shields.io/badge/Database-SQLite-003B57?logo=sqlite&logoColor=white)

> "Quanto mais você interage, mais demoníaco ele fica. E sim, isso é intencional."

**HappyDemon** é um chatbot desktop que **aprende continuamente** com o usuário. Diferente das IAs cheias de filtros que só sabem dizer "não posso responder isso", o HappyDemon tem **personalidade, memória infinita e fala 3 idiomas**.
...
1. Baixe o arquivo `HappyDemon.exe`
2. Dê dois cliques
3. O banco de dados `happy_demon.db` será criado automaticamente na mesma pasta
